...
```bash
git clone https://github.com/WoodpeckerLaud/coreutils-544.git
cd coreutils-544
cargo build --release
cargo run
```
...
A Microsoft-maintained build of [uutils/coreutils](https://github.com/WoodpeckerLaud/coreutils-544),
...
<!-- Last updated: 2026-06-06 14:57:11 -->
